...
object MainData {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 
        //
        val p = new PrintWriter("_output/order-details-%s.csv".format(t_formattedDate));

        val f_header = "orderNumber,qty,unitCost,extTotal,productCode\n";
        ...
        for( i <- 1 to 50) {
          ...
          var f_qty = "%03d-%03d-%04d".format(rand.nextInt(999), rand.nextInt(99), rand.nextInt(6999));
          var f_unitcost = "%03d-%02d-%04d".format(rand.nextInt(399), rand.nextInt(99), rand.nextInt(6999));
          var f_exttotal = "%02d-%02d-%04d".format(rand.nextInt(12), rand.nextInt(27), rand.nextInt((2023 - 1950))+1950)
          var f_productcode = "";
          var f_loyaltyLevel = "";
          var f_ageBand = 0;
